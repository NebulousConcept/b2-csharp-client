...
{
    /// <summary>
    /// The response object for the 'b2_delete_bucket' version 1 API.
    /// </summary>
    [DataContract]
    public sealed class DeleteBucketV1Response : IResponse
    {
        /// <summary>
        /// The account ID.
        /// </summary>
        ...
        /// <param name="LifecycleRules">The lifecycle rules.</param>
        /// <param name="Revision">The bucket revision.</param>
        [SuppressMessage("ReSharper", "InconsistentNaming")]
        public DeleteBucketV1Response(string AccountId, string BucketId, string BucketName, BucketType BucketType,
